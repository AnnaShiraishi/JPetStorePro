...
<div id="Catalog" class="container">
	<form action="${pageContext.request.contextPath}/myaccount" method="post">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="username" value="${account.username}" disabled id="usernameEdit" />
		...
		<div class="form-row">
			<div class="form-group col-md-3">
				...
				<input type="text" class="form-control" name="city" value="${account.city}" id="inputCity">
			</div>
			<div class="form-group col-md-3">
				<label for="inputState">State</label>
				<input type="text" class="form-control" name="state" value="${account.state}" id="inputState">
			</div>
			<div class="form-group col-md-3">
				<label for="inputZip">Zip</label>
				<input type="text" class="form-control" name="zip" value="${account.zip}" id="inputZip">
			</div>
			<div class="form-group col-md-3">
				<label for="inputCountry">Country</label>
				<input type="text" class="form-control" name="country" value="${account.country}" id="inputCountry">
			</div>
		</div>
		...
		<input class="btn btn-success" name="editAccount" value="Save Account Information" type="submit"><br><br>
		<a class="btn btn-success" href="${pageContext.request.contextPath}/listorders">My Orders</a>
